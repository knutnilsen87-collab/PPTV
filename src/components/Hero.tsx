  ...
  return (
    <section className="relative overflow-hidden rounded-2xl border p-6 md:p-10">
      <div className="max-w-xl">
        ...
        <p className="mt-2 text-sm md:text-base text-neutral-600 dark:text-neutral-300">A short, elite hand breakdown selected by coaches â€” watch in under 5 minutes.</p>
